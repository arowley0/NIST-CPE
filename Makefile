# This Makefile is for the NIST::CPE extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/NIST/CPE.pm]
#     AUTHOR => [q[Andi Rowley <andi.rowley@c9h.com>]]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/NIST/CPE.pm]
#     clean => { FILES=>q[NIST-CPE-*] }
...
MAKEMAKER   = /usr/local/share/perl/5.22.2/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.2
MM_REVISION = 72000
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/NIST/CPE.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/NIST
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/NIST
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/NIST/CPE.pm $(INST_MAN3DIR)/NIST::CPE.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new NIST::CPE!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Andi Rowley <andi.rowley@c9h.com>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'build_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'configure_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  ExtUtils::MakeMaker: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'dynamic_config: 1' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 7.2, CPAN::Meta::Converter version 2.150005'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'license: artistic_2' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: '\''1.4'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: NIST-CPE' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new NIST::CPE!",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Andi Rowley <andi.rowley@c9h.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	$(NOECHO) $(ECHO) '   "dynamic_config" : 1,' >> META_new.json
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 7.2, CPAN::Meta::Converter version 2.150005",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "NIST-CPE",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="NIST-CPE" VERSION="0.01">' > NIST-CPE.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new NIST::CPE!</ABSTRACT>' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Andi Rowley &lt;andi.rowley@c9h.com&gt;</AUTHOR>' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '        <PERLCORE VERSION="5,006,0,0" />' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.22" />' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> NIST-CPE.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> NIST-CPE.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/NIST/CPE.pm' 'blib/lib/NIST/CPE.pm' 
